    ...
    <div className="max-w-7xl mx-auto space-y-12 pb-24">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-gray-100 pb-10">
        <div className="w-full">
          ...
          <p className="text-gray-400 font-bold uppercase tracking-widest text-[10px] md:text-xs">
            Combat Corner Bangladesh Operations
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {adminStats.map((stat, index) => (
          <div
            key={index}
            className="group relative bg-white rounded-[32px] p-8 border border-gray-100 shadow-2xl shadow-gray-200/40 overflow-hidden transition-all duration-500 hover:-translate-y-2"
          >
            <div
              className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br ${stat.color} opacity-5 rounded-full -mr-10 -mt-10 group-hover:scale-150 transition-transform duration-700`}
            />
            ...
            <div className="flex items-center justify-between relative z-10">
              ...
              <div
                className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${stat.color} flex items-center justify-center text-2xl text-white shadow-xl ${stat.shadow} transform transition-all duration-500 group-hover:rotate-12`}
              >
                <stat.icon />
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 bg-white rounded-[40px] shadow-2xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
          <div className="p-10 border-b border-gray-50 flex justify-between items-center">
            ...
            <Link
              ...
              className="text-gray-400 hover:text-orange-600 flex items-center gap-2 text-xs font-black uppercase tracking-widest transition-colors group"
            >
              View Database{" "}
          ...
          <div className="p-6 space-y-2">
            {blogsData?.slice(0, 5).map((blog) => (
              <div
                key={blog._id}
                className="flex items-center justify-between p-4 rounded-3xl hover:bg-orange-50/50 transition-all duration-300 group border border-transparent hover:border-orange-100"
              >
                <div className="flex items-center gap-6 flex-1 min-w-0">
                  ...
                  <div className="min-w-0 pr-4">
                    <h3 className="font-black text-gray-900 truncate uppercase tracking-tight text-sm mb-2">
                      {blog.title}
                    </h3>
                ...
                <div className="flex items-center gap-4 opacity-0 group-hover:opacity-100 transition-opacity">
                  <Link
                    ...
                    className="p-3 bg-white shadow-md rounded-xl text-gray-400 hover:text-orange-600 hover:bg-orange-600 hover:text-white transition-all"
                  >
        ...
        <div className="space-y-8">
          <div className="bg-gray-900 rounded-[40px] p-10 text-white relative overflow-hidden shadow-2xl">
            ...
            <h3 className="text-xl font-black uppercase tracking-tighter mb-8 relative z-10">
              Quick Launch
            </h3>
            <div className="space-y-4 relative z-10">
              <Link
                to="/dashboard/add-post"
                className="flex items-center justify-between w-full bg-orange-600 hover:bg-orange-700 p-6 rounded-[24px] font-black uppercase tracking-widest text-xs transition-all active:scale-95 shadow-xl shadow-orange-900/40"
              >
                Create New Story <FaFileAlt />
              </Link>
              <Link
                to="/dashboard/manage-items"
                className="flex items-center justify-between w-full bg-white/10 hover:bg-white/20 p-6 rounded-[24px] font-black uppercase tracking-widest text-xs transition-all"
              >
          ...
          <div className="bg-orange-600 rounded-[40px] p-10 text-white shadow-2xl shadow-orange-200">
            ...
            <p className="text-orange-100 text-sm font-medium leading-relaxed opacity-80 uppercase tracking-tight">
              Keep your content fresh. Top news portals update at least 3-5
              times daily to stay relevant in combat sports.
            </p>
          </div>
        </div>
      </div>
