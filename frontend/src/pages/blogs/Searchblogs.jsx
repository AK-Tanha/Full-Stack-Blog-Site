...
const Searchblogs = ({ search, handleSearchChange, handleSearch, category, handleCategoryChange }) => {
  ...
  return (
    <div className="w-full bg-white border border-gray-200 rounded-2xl shadow-sm mb-12 overflow-hidden">
      <div className="flex flex-col md:flex-row items-stretch">
        ...
        <div className="flex-grow flex items-center px-6 py-4 border-b md:border-b-0 md:border-r border-gray-100 group">
          ...
          <input
            ...
            type="text"
            placeholder="Search news, fighters, or events..."
            className="w-full px-4 bg-transparent text-gray-800 placeholder:text-gray-400 focus:outline-none font-medium"
          />
        </div>
        
        {/* Category Select Section */}
        <div className="flex items-center px-6 py-4 border-b md:border-b-0 md:border-r border-gray-100 bg-gray-50/50">
          <FiFilter className="text-gray-400 mr-3 w-4 h-4" />
          <select
            value={category}
            onChange={handleCategoryChange}
            className="bg-transparent text-gray-700 font-bold text-sm uppercase tracking-wider focus:outline-none appearance-none cursor-pointer pr-8"
